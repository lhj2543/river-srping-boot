 ...
 */
public class RiverUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			String userCd = (String) map.get(SecurityConstants.DETAILS_USER_CD);
			String userName = (String) map.get(SecurityConstants.DETAILS_USERNAME);
			Set<SysUserRoleDto> userRoles = new HashSet<>((List<SysUserRoleDto>) map.get(SecurityConstants.DETAILS_USER_ROLES));

			RiverUser user = new RiverUser(userId,userName,userRoles,userCd, N_A, true, true, true, true, authorities);
